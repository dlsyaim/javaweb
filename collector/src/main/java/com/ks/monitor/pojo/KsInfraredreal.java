...
public class KsInfraredreal {
    private Long infraredRealID;
    ...
    public Long getInfraredRealID() {
        return infraredRealID;
    }

    public void setInfraredRealID(Long infraredRealID) {
        this.infraredRealID = infraredRealID;
    }
