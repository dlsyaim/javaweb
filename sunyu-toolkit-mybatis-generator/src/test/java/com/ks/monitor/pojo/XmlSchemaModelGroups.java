...
public class XmlSchemaModelGroups {
    ...
    private String compositor_desc;
    ...
    public void setCompositor(String compositor) {
        this.compositor = compositor == null ? null : compositor.trim();
    }

    public String getCompositor_desc() {
        return compositor_desc;
    }

    public void setCompositor_desc(String compositor_desc) {
        this.compositor_desc = compositor_desc == null ? null : compositor_desc.trim();
    }
}