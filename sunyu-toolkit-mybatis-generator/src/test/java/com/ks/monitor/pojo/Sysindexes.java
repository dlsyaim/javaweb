...
public class Sysindexes {
    ...
    private Byte origFillFactor;

    private Byte statVersion;
    ...
    public Byte getOrigFillFactor() {
        return origFillFactor;
    }

    public void setOrigFillFactor(Byte origFillFactor) {
        this.origFillFactor = origFillFactor;
    }

    public Byte getStatVersion() {
        return statVersion;
    }

    public void setStatVersion(Byte statVersion) {
