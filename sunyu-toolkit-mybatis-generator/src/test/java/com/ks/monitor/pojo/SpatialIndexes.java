...
public class SpatialIndexes {
    ...
    private Integer spatial_index_type;

    private String spatial_index_type_desc;
    ...
    public Integer getSpatial_index_type() {
        return spatial_index_type;
    }

    public void setSpatial_index_type(Integer spatial_index_type) {
        this.spatial_index_type = spatial_index_type;
    }

    public String getSpatial_index_type_desc() {
        return spatial_index_type_desc;
    }

    public void setSpatial_index_type_desc(String spatial_index_type_desc) {
        this.spatial_index_type_desc = spatial_index_type_desc == null ? null : spatial_index_type_desc.trim();
    }
