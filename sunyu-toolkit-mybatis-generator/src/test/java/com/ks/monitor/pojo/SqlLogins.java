...
public class SqlLogins {
    ...
    private Boolean is_policy_checked;

    private Boolean is_expiration_checked;
    ...
    public Boolean getIs_policy_checked() {
        return is_policy_checked;
    }

    public void setIs_policy_checked(Boolean is_policy_checked) {
        this.is_policy_checked = is_policy_checked;
    }

    public Boolean getIs_expiration_checked() {
        return is_expiration_checked;
    }

    public void setIs_expiration_checked(Boolean is_expiration_checked) {
