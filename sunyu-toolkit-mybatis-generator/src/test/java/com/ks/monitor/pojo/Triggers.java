...
public class Triggers {
    ...
    private Boolean is_instead_of_trigger;
    ...
    public Boolean getIs_instead_of_trigger() {
        return is_instead_of_trigger;
    }

    public void setIs_instead_of_trigger(Boolean is_instead_of_trigger) {
